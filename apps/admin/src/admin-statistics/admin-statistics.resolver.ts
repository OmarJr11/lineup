...
export class AdminStatisticsResolver {
  ...
  async adminBusinessStats(
    ...
    return await this.adminStatisticsGettersService.getBusinessStats(
      timePeriod,
    );
  }
   ...
   */
  @Query(() => AdminPlatformEngagementStatsSchema, {
    name: 'adminPlatformEngagementStats',
  })
  @UseGuards(JwtAuthGuard, TokenGuard, PermissionsGuard)
  @Permissions(AdminPermissionsEnum.STATS)
  @Response(userResponses.list)
  async adminPlatformEngagementStats(
    ...
    return await this.adminStatisticsGettersService.getPlatformEngagementStats(
      timePeriod,
    );
  }
   ...
   */
  @Query(() => AdminCatalogGlobalStatsSchema, {
    name: 'adminCatalogGlobalStats',
  })
  @UseGuards(JwtAuthGuard, TokenGuard, PermissionsGuard)
  @Permissions(AdminPermissionsEnum.STATS)
  @Response(userResponses.list)
   ...
   */
  @Query(() => AdminDiscountGlobalStatsSchema, {
    name: 'adminDiscountGlobalStats',
  })
  @UseGuards(JwtAuthGuard, TokenGuard, PermissionsGuard)
  @Permissions(AdminPermissionsEnum.STATS)
  @Response(userResponses.list)
  async adminDiscountGlobalStats(
    ...
    return await this.adminStatisticsGettersService.getDiscountGlobalStats(
      days,
    );
  }
}
