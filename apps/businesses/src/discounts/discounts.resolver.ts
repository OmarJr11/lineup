...
export class DiscountsResolver {
  ...
  async create(
    ...
    return toDiscountSchema(
      await this.discountsService.create(data, businessReq),
    );
  }
  ...
  async update(
    ...
    return toDiscountSchema(
      await this.discountsService.update(data, businessReq),
    );
  }
  ...
  async findOne(
    ...
    return toDiscountSchema(
      await this.discountsService.findOne(id, businessReq),
    );
  }
  ...
  async findAllMyDiscountsByScope(
    ...
    const result = await this.discountsService.findAllMyDiscountsByScope(
      data,
      pagination,
      businessReq,
    );
  ...
  @Query(() => DiscountSchema, {
    nullable: true,
    name: 'findActiveDiscountByProduct',
  })
  @UseGuards(JwtAuthGuard, TokenGuard, PermissionsGuard)
  @Permissions(DiscountsPermissionsEnum.DISCREAD)
  async findActiveDiscountByProduct(
    ...
    const discount = await this.discountsService.findActiveDiscountByProduct(
      idProduct,
      businessReq,
    );
  ...
  async findAuditByProduct(
    ...
    return (
      await this.discountsService.findAuditByProduct(
        idProduct,
        businessReq,
        limit ?? 50,
      )
  ...
  async findAuditByDiscount(
    ...
    return (
      await this.discountsService.findAuditByDiscount(
        idDiscount,
        businessReq,
        limit ?? 50,
      )
