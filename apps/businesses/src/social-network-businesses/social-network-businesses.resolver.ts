...
export class SocialNetworkBusinessesResolver {
  ...
  @Mutation(() => SocialNetworkBusinessSchema, {
    name: 'createSocialNetworkBusiness',
  })
  ...
  async create(
    ...
    const socialNetworkBusiness =
      await this.socialNetworkBusinessesService.create(data, businessReq);
    return toSocialNetworkBusinessSchema(socialNetworkBusiness);
  }

  @Query(() => [SocialNetworkBusinessSchema], {
    name: 'findAllMySocialNetworkBusinesses',
  })
  @UseGuards(JwtAuthGuard, TokenGuard)
  async findAllMySocialNetworkBusinesses(
    @BusinessDec() businessReq: IBusinessReq,
  ) {
    const socialNetworkBusinesses =
      await this.socialNetworkBusinessesService.findByBusiness(
        businessReq.businessId,
      );
    return socialNetworkBusinesses.map((snb) =>
      toSocialNetworkBusinessSchema(snb),
    );
  }
  ...
  async findByBusiness(
    ...
    const socialNetworkBusinesses =
      await this.socialNetworkBusinessesService.findByBusiness(idBusiness);
    return socialNetworkBusinesses.map((snb) =>
      toSocialNetworkBusinessSchema(snb),
    );
  }
  ...
  @Query(() => SocialNetworkBusinessSchema, {
    name: 'findOneSocialNetworkBusiness',
  })
  async findOne(@Args('id', { type: () => Int }) id: number) {
    const socialNetworkBusiness =
      await this.socialNetworkBusinessesService.findOne(id);
    return toSocialNetworkBusinessSchema(socialNetworkBusiness);
  }

  @Mutation(() => SocialNetworkBusinessSchema, {
    name: 'updateSocialNetworkBusiness',
  })
  @UseGuards(JwtAuthGuard, TokenGuard, PermissionsGuard)
  ...
  async update(
    ...
    const socialNetworkBusiness =
      await this.socialNetworkBusinessesService.update(data, businessReq);
    return toSocialNetworkBusinessSchema(socialNetworkBusiness);
  }
  ...
  async remove(
    ...
    const result = await this.socialNetworkBusinessesService.remove(
      id,
      businessReq,
    );
    return result;
