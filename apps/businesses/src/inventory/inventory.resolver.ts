...
import { ProductSkuSchema, StockMovementSchema } from '../../../../core/schemas';
...
export class InventoryResolver {
    ...
    async getStockByProduct(
        ...
        await this.productsGettersService.findOneByBusinessId(idProduct, idBusiness);
        const skus = await this.productSkusService.findAllByProductAndBusiness(idProduct, idBusiness);
    ...
    async getStockHistory(
        @Args('idProductSku', { type: () => Int, nullable: true }) idProductSku: number | null,
