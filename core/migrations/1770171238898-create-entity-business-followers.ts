...
export class CreateEntityBusinessFollowers1770171238898 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "businesses" RENAME COLUMN "likes" TO "followers"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "businesses" RENAME COLUMN "followers" TO "likes"`);
    }
