...
export class RefactorInRolesEnum1749512851793 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "system"."roles_code_enum" AS ENUM('01ADMLUP', '02USERLUP', '03MODLUP', '05BUSSLUP')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(
      `CREATE TYPE "system"."roles_code_enum_old" AS ENUM('01ADMLUP', '02USERLUP', '03MODLUP')`,
    );
    await queryRunner.query(
