...
export class FixTagsEntity1773286611258 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product_tags" DROP CONSTRAINT "FK_product_tags_product"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_tags" DROP CONSTRAINT "FK_product_tags_tag"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tags" ADD "id_creation_business" bigint NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "discounts" ALTER COLUMN "status" SET DEFAULT 'pending'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tags" ADD CONSTRAINT "FK_425ac450d473c354c9538ae8d4a" FOREIGN KEY ("id_creation_business") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "system"."states" ADD CONSTRAINT "FK_04cf2b205b52a2cf37e0ffe6106" FOREIGN KEY ("id_creation_user") REFERENCES "system"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "system"."states" ADD CONSTRAINT "FK_ac67f5a0c2724094f858c1bef52" FOREIGN KEY ("id_modification_user") REFERENCES "system"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "system"."users" ADD CONSTRAINT "FK_3da882e9fd07cd3129d70162533" FOREIGN KEY ("id_state") REFERENCES "system"."states"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "system"."users" DROP CONSTRAINT "FK_3da882e9fd07cd3129d70162533"`,
    );
    await queryRunner.query(
      `ALTER TABLE "system"."states" DROP CONSTRAINT "FK_ac67f5a0c2724094f858c1bef52"`,
    );
    await queryRunner.query(
      `ALTER TABLE "system"."states" DROP CONSTRAINT "FK_04cf2b205b52a2cf37e0ffe6106"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tags" DROP CONSTRAINT "FK_425ac450d473c354c9538ae8d4a"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tags" DROP COLUMN "id_creation_business"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_tags" ADD CONSTRAINT "FK_product_tags_tag" FOREIGN KEY ("id_tag") REFERENCES "tags"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_tags" ADD CONSTRAINT "FK_product_tags_product" FOREIGN KEY ("id_product") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
