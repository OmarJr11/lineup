...
export class CreateNewEntityAudits1773877361534 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "entity_audits" ("id" BIGSERIAL NOT NULL, "entity_name" character varying(100) NOT NULL, "entity_id" bigint NOT NULL, "operation" "public"."entity_audits_operation_enum" NOT NULL, "old_values" jsonb, "new_values" jsonb, "id_creation_business" bigint, "id_creation_user" bigint, "creation_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "CHK_entity_audits_creator" CHECK ((id_creation_business IS NOT NULL) OR (id_creation_user IS NOT NULL)), CONSTRAINT "PK_4194b9433700bc5ee04bcf08224" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "entity_audits" ADD CONSTRAINT "FK_d343ff7cda0a6e6490629a61ae4" FOREIGN KEY ("id_creation_business") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "entity_audits" ADD CONSTRAINT "FK_eb12566b96d97b52ab781c145e5" FOREIGN KEY ("id_creation_user") REFERENCES "system"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "discount_product_audits" DROP CONSTRAINT IF EXISTS "FK_1601fa2aa05295ccc76ac9817b4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "discount_product_audits" DROP CONSTRAINT IF EXISTS "FK_fc6178059793695e30d3997de2d"`,
    );
    await queryRunner.query(`DROP TABLE IF EXISTS "discount_product_audits"`);
    await queryRunner.query(
      `DROP TYPE IF EXISTS "public"."discount_product_audits_operation_enum"`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(
      `ALTER TABLE "entity_audits" DROP CONSTRAINT "FK_eb12566b96d97b52ab781c145e5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "entity_audits" DROP CONSTRAINT "FK_d343ff7cda0a6e6490629a61ae4"`,
    );
