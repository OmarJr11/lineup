...
export class CreateEntityCurrencies1770419199392 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."currencies_status_enum" AS ENUM('active', 'inactive', 'pending', 'suspended', 'deleted', 'completed', 'rejected', 'approved', 'failed', 'denied')`,
    );
    await queryRunner.query(
      `CREATE TABLE "currencies" ("creation_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "modification_date" TIMESTAMP WITH TIME ZONE DEFAULT now(), "creation_ip" character varying(50), "modification_ip" character varying(50), "creation_coordinate" point, "modification_coordinate" point, "id" BIGSERIAL NOT NULL, "name" character varying(100) NOT NULL, "code" character varying(10) NOT NULL, "id_creation_user" bigint NOT NULL, "status" "public"."currencies_status_enum" NOT NULL DEFAULT 'active', CONSTRAINT "UQ_9f8d0972aeeb5a2277e40332d29" UNIQUE ("code"), CONSTRAINT "PK_d528c54860c4182db13548e08c4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "currencies" ADD CONSTRAINT "FK_66b8b2d3a683ccf4d0ea78642bc" FOREIGN KEY ("id_creation_user") REFERENCES "system"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "products" ALTER COLUMN "subtitle" DROP NOT NULL`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "currencies" DROP CONSTRAINT "FK_66b8b2d3a683ccf4d0ea78642bc"`,
    );
    await queryRunner.query(
