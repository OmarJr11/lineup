...
@Index(
  'IDX_unique_active_social_network_business',
  ['idCreationBusiness', 'idSocialNetwork'],
  {
    unique: true,
...
export class SocialNetworkBusiness extends BaseEntity {
  ...
  @ManyToOne(
    () => SocialNetwork,
    (socialNetwork) => socialNetwork.socialNetworkBusinesses,
  )
  ...
  @ManyToOne(
    () => Business,
    (business) => business.modifiedSocialNetworkBusinesses,
  )
