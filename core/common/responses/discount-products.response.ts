...
export const discountProductsResponses = {
    create: {
        ...
        error: {
            code: 3011100,
            status: false,
            message: 'The discount product could not be created, an error has occurred.',
        },
        success: {
            code: 3011100,
            status: true,
    ...
    list: {
        ...
        error: {
            code: 3011200,
            status: false,
            message: 'The discount product(s) could not be listed, an error has occurred.',
        },
        success: {
            code: 3011200,
            status: true,
    ...
    delete: {
        ...
        error: {
            code: 3011300,
            status: false,
            message: 'The discount product(s) could not be deleted, an error has occurred.',
        },
        success: {
            code: 3011300,
            status: true,
