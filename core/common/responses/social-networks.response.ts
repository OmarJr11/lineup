export const socialNetworksResponse = {
  create: {
    ...
    error: {
      ...
      status: false,
      message:
        'The Social Network could not be created, an error has occurred.',
    },
    success: {
      code: 1310100,
      status: true,
  ...
  update: {
    ...
    error: {
      ...
      status: false,
      message:
        'The Social Network could not be updated, an error has occurred.',
    },
    success: {
      code: 1310200,
      status: true,
  ...
  list: {
    ...
    error: {
      ...
      status: false,
      message:
        'The Social Network(s) could not be listed, an error has occurred.',
    },
    success: {
      code: 1310300,
      status: true,
  ...
  inactive: {
    ...
    error: {
      ...
      status: false,
      message:
        'The Social Network could not be disabled, an error has occurred.',
    },
    success: {
      code: 1310400,
      status: true,
  ...
  active: {
    ...
    error: {
      ...
      status: false,
      message:
        'The Social Network could not be enabled, an error has occurred.',
    },
    success: {
      code: 1310500,
      status: true,
  ...
  delete: {
    ...
    error: {
      ...
      status: false,
      message:
        'The Social Network could not be deleted, an error has occurred.',
    },
    success: {
      code: 1310600,
      status: true,
