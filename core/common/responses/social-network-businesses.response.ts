export const socialNetworkBusinessesResponses = {
  create: {
    ...
    contactMismatch: {
      ...
      status: false,
      message:
        'The contact type (url or phone) does not match the selected social network requirements.',
    },
    error: {
      code: 1400199,
      status: false,
      message:
        'The Social Network Business could not be created, an error has occurred.',
    },
    success: {
      code: 1410100,
      status: true,
  ...
  update: {
    ...
    error: {
      ...
      status: false,
      message:
        'The Social Network Business could not be updated, an error has occurred.',
    },
    success: {
      code: 1410200,
      status: true,
  ...
  list: {
    ...
    error: {
      ...
      status: false,
      message:
        'The Social Network Business(es) could not be listed, an error has occurred.',
    },
    success: {
      code: 1410300,
      status: true,
  ...
  delete: {
    ...
    error: {
      ...
      status: false,
      message:
        'The Social Network Business could not be deleted, an error has occurred.',
    },
    success: {
      code: 1410400,
      status: true,
