export const productVariationsResponses = {
  create: {
    ...
    error: {
      ...
      status: false,
      message:
        'The Product Variation could not be created, an error has occurred.',
    },
    success: {
      code: 1011100,
      status: true,
  ...
  update: {
    ...
    error: {
      ...
      status: false,
      message:
        'The Product Variation could not be updated, an error has occurred.',
    },
    success: {
      code: 1011200,
      status: true,
  ...
  list: {
    ...
    error: {
      ...
      status: false,
      message:
        'The Product Variation(s) could not be listed, an error has occurred.',
    },
    success: {
      code: 1011300,
      status: true,
  ...
  delete: {
    ...
    error: {
      ...
      status: false,
      message:
        'The Product Variation could not be deleted, an error has occurred.',
    },
    success: {
      code: 1011600,
      status: true,
